...
char* getTimeStampBuffer()
{
    ...
    sprintf(buffer, "%hu:%hu:%hu", hours_bin, minutes_bin, seconds_bin);

    return buffer;
}

char* getDateStampBuffer()
{
    static char buffer[100] = {};
    ...
    years_bin += 2000;
    sprintf(buffer, "%hu.%hu.%hu", days_bin, months_bin, years_bin);
